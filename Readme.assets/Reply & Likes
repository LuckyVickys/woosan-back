...
### Overview
사용자가 게시물이나 댓글에 대해 추천(좋아요)을 할 수 있는 기능을 제공합니다. 이 기능은 사용자의 상호작용을 유도하며, 추천 상태를 토글(추가 및 취소)하고, 현재 추천 여부를 확인할 수 있습니다. 추천을 통해 사용자는 게시물이나 댓글에 긍정적인 피드백을 남길 수 있으며, 추천 수에 따라 게시물이나 댓글의 인기도를 반영할 수 있습니다.
