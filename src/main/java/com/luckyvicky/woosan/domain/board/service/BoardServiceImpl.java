...
public class BoardServiceImpl implements BoardService {
    ...
    public Long createBoard(BoardDTO boardDTO) {
        validate.validateBoardInput(boardDTO); // 입력값 검증
        Member writer = validate.validateAndFetchWriter(boardDTO.getWriterId()); // 작성자 검증 및 조회
    ...
    public BoardPageResponseDTO getBoardList(PageRequestDTO pageRequestDTO, String categoryName) {
        ...
        PageResponseDTO<BoardListDTO> boardPage = createPageResponseDTO(pageRequestDTO, dtoList, result.getTotalElements()); // 페이지 응답 DTO 생성
    ...
    public BoardDTO getBoard(Long id) {
        ...
        Board board = findBoardById(id); // 게시물 조회
    ...
    public BoardDTO getBoardForUpdate(Long id) {
        validate.validateBoardExist(id); // 게시물 존재 여부 검증
    ...
    public void updateBoard(BoardDTO boardDTO) {
        validate.validateBoardInput(boardDTO); // 입력값 검증
        validate.checkBoardOwnership(boardDTO.getId(), boardDTO.getWriterId()); // 소유자 검증
    ...
    public void deleteBoard(RemoveDTO removeDTO) {
        validate.validateBoardExist(removeDTO.getId()); // 게시물 존재 여부 검증
        validate.checkBoardOwnership(removeDTO.getId(), removeDTO.getWriterId()); // 소유자 검증
...
//    <---------------------------------------------------------------->
     ...
     * 페이지 응답 DTO 생성
     */
    private PageResponseDTO<BoardListDTO> createPageResponseDTO(PageRequestDTO pageRequestDTO, List<BoardListDTO> dtoList, long totalCount) {
